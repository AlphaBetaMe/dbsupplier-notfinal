...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard', compact('dataChartValue','dataChartLabel','commisions','customers','bookings','stocks','products', 'users','posdetails','ecomOrder','posChartlabel', 'posChartVal','dailySalesLabels','dailySalesValues','weeklySalesLabels','weeklySalesValues'));
    }
