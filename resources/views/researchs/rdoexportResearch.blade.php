...
<!-- <div class="container-fluid">
    ...
    <div class="mt-2 py-2">
        ...
        <div class="alert alert-danger">
            <strong>whoops</strong> There were som problems in the inputs!
            <ul>
    ...
    <div class="mt-2 py-2">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('researchs.rdoexport') }}" class="float-right btn btn-success btn-sm">
                ...
                <form method="GET">
                    <div class="input-group mb-3">
                        ...
                        <a href="{{ route('researchs.rdoexportResearch')}}" class="btn btn-info">Refresh</a>
                    </div>
                </form>
            </div>
            <div class="card-body">
