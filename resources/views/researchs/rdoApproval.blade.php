            ...
            <div class="card-header">
                ...
                <form method="GET">
                    <div class="input-group mb-3">
                        ...
                        <a href="{{ route('researchs.rdoApproval')}}" class="btn btn-info">Refresh</a>
                    </div>
                </form>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-condense table-bordered table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('researchs.rdoresearchApproved', $file->id) }}" class="btn btn-info ">Approve</a>
                                <a href="{{ route('researchs.rdoresearchDisapproved', $file->id)}}" class="btn btn-danger">Disapproved</a>    
                            </div>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="8">No research found.</td>
                        </tr>
                        @endforelse
                    </table>
                </div>
